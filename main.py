...
#конфиг
BOT_TOKEN = '5526754899:AAER1ZhtQSWiE6w-mlPYuTT_upEEsVTba-g'#Токен бота
ADMIN_LIST = [1663955345] #Id админа
...
async def start(message : types.Message, state: FSMContext):
    ...
    await bot.send_message(message.chat.id, f'<b>👋 Привет! Это Анонимный чат 18+ 😍</b>\n'
                                            f'<i>Тут можно общаться 1 на 1 со случайными собеседниками на темы сексуального характера.</i>\n\n'
                                            ...
                                            f'<b>🔎 Работает бот очень просто:</b> вы жмете кнопку поиска или используете команду /search и бот находит вам собеседника.',reply_markup=mark_menu, parse_mode=types.ParseMode.HTML)
